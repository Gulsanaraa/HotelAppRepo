...
import function.HotelApp_BussinessFunction;
import io.github.bonigarcia.wdm.WebDriverManager;

public class ParamaterizationLoopTest{
	 private WebDriver driver;
	  private String baseUrl;
	  private boolean acceptNextAlert = true;
	  private StringBuffer verificationErrors = new StringBuffer();
	  private JavascriptExecutor js;
	  private DataDrivenFunc dataDrivenFunc ;
	  private HotelApp_BussinessFunction bFunc;
	  ...
	  @Test
	  public void testParamaterizationLoop() throws Exception {
	   // driver.get("https://adactinhotelapp.com/HotelAppBuild2/");
	    
	    driver.get (baseUrl);
	    dataDrivenFunc = new DataDrivenFunc();
	    bFunc = new HotelApp_BussinessFunction();

	    int Xlcount = dataDrivenFunc.HA_GF_XLRowCount("C:\\Users\\61470\\OneDrive\\Desktop\\gul\\Testing\\Adactin Eclipse Workspace\\AdactinHotelAppMaven\\src\\test\\resources\\DataPool\\HA_HotelSearch.xls", "Location");
	    String sLocation ="";
	    for (int i = 1; i <Xlcount; i++) {

	    sLocation = dataDrivenFunc.HA_GF_readXL(i, "Location", "C:\\Users\\61470\\OneDrive\\Desktop\\gul\\Testing\\Adactin Eclipse Workspace\\AdactinHotelAppMaven\\src\\test\\resources\\DataPool\\HA_HotelSearch.xls") ;
