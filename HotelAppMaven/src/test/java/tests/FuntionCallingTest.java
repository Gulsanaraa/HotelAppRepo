...
public class FuntionCallingTest extends HotelApp_BussinessFunction {
	  ...
	  @Test
	  public void testFuntionCalling() throws Exception {
	    driver.get("https://adactinhotelapp.com/HotelAppBuild2/");
	    
	    loginFun(driver, "gularaa123", "gularaa123");
