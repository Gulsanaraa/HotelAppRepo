...
public void testFirstKatalonTestScript() throws Exception {
  ...
  String slocation = driver.findElement(By.id("location") ).getAttribute("value");
  if(slocation.equalsIgnoreCase("Sydney")) {
	  ...
	  System.out.println("Searched location is incorrect on search page. Actual location is "+slocation);
